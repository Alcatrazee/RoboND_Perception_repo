...
# intro: if you want to change the svm target, change the model .sav file in line 43
...
pickle.dump(model, open(
    '/home/alcatraz/catkin_ws/src/sensor_stick/sav/trainned.sav', 'wb'))
...
plt.figure()
plot_confusion_matrix(confusion_matrix, classes=encoder.classes_, normalize=False,
